...
def enlarge(table):
    ...
    table.num_items = 0
    # print(type(table))
    # if type(table) == HashTableSepchain:
    #     new_table = HashTableSepchain(new_cap)
    # elif type(table) == HashTableSepchain:
    #     new_table = HashTableLinear(new_cap)
    # else:
    #     new_table = HashTableQuadratic(new_cap)
    for item in copy:
        # print('item', item)
        while item:
